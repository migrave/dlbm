"""
    ...
    It is used to augment the frames with 15 new backgrounds.
...
class Augmentor:
    def __init__(self):
        self.backgrounds_path = "/home/michal/thesis/dl_behaviour_model_multiclass/new_backgrounds/train"
    ...
    def augment(self, image):
        ...
        for i, background_name in enumerate(self.backgrounds):
            if background_name == 'test':
                continue
            background = cv2.imread(os.path.join(self.backgrounds_path, background_name), cv2.IMREAD_GRAYSCALE)
...
DATASET_PATH = "/home/michal/thesis/merged_frames"
...
for cat in CLASSES:
    ...
    for image_name in tqdm(image_names):
        ...
        for i, img in enumerate(augmented_imgs):
            ...
            cv2.imwrite(os.path.join(OUTPUT_PATH, cat, new_image_name), img)
