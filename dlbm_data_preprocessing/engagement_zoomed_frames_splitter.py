...
'''
    ...
    where participants acting engaged/disengaged.
        ...
        for s_id, series in enumerate(frame_series):
            ...
            for f_id, frame in enumerate(series_frames):
                ...
                if category == 'feedback':
                    path = os.path.join(OUTPUT_PATH, category, f"{idx}_extra_1{s_id}_{f_id}.jpg")
                else:
                    path = os.path.join(OUTPUT_PATH, label_dict[s_id], f"{idx}_extra_1{s_id}_{f_id}.jpg")
