'''
    ...
    It is used to train VideoResNet18.
...
from config import config_resnet3d as dcfg

def main():
    torch.cuda.empty_cache()
    torch.manual_seed(torch.initial_seed())

    model_dir = 'results/resnet3d'

    agent = DeepClassifier(cfg=dcfg, input_state_size=8, rgb=True, name="resnet3d")
