"""
    ...
    This file is part of dl_behaviour_model_binary.
     It is used to remove background from the frames in order to create an extra test set.
...
for cat in CLASSES:
    ...
    for image_name in tqdm(image_names):
        ...
        cv2.imwrite(os.path.join(OUTPUT_PATH, cat, new_image_name), augmented_img)