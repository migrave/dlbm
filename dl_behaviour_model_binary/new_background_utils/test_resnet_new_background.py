"""
    ...
    It is used to test ResNet50 and VideoResNet18 on the extra test sets (with five new backgrounds/without background).
...
params = {'n_frames_used': 8, 'rgb': True, 'standardization': False}

test = InteractionDataset(path='/home/michal/thesis/white_background_frames', **params)
#test = InteractionDataset(path='/home/michal/thesis/test_frames', **params)
...
disp.plot()
disp.figure_.savefig(f"/home/michal/thesis/dl_behaviour_model/plots/resnet3d/"
                     f"Resnet3d_{name_suffix}.pdf", bbox_inches="tight")

fig, ax = plt.subplots(figsize=(10, 10))
disp = ConfusionMatrixDisplay(confusion_matrix=conf_matrix_majority,
                              display_labels=display_labels)
disp.plot()
disp.figure_.savefig(f"/home/michal/thesis/dl_behaviour_model/plots/resnet/"
                     f"Resnet_{name_suffix}.pdf", bbox_inches="tight")
